...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_PlayerActionRPCCommandSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    [System.Runtime.CompilerServices.CompilerGenerated]
    [BurstCompile]
    internal struct Assembly_CSharp_Generated_PlayerActionRPCSerializer : IComponentData, IRpcCommandSerializer<PlayerActionRPC>
    {
        public void Serialize(ref DataStreamWriter writer, in RpcSerializerState state, in PlayerActionRPC data)
        {
        ...
        {
            RpcExecutor.ExecuteCreateRequestComponent<Assembly_CSharp_Generated_PlayerActionRPCSerializer, PlayerActionRPC>(ref parameters);
        }
    ...
    [BurstCompile]
    internal partial struct Assembly_CSharp_Generated_PlayerActionRPCRpcCommandRequestSystem : ISystem
    {
        RpcCommandRequest<Assembly_CSharp_Generated_PlayerActionRPCSerializer, PlayerActionRPC> m_Request;
        [BurstCompile]
        struct SendRpc : IJobChunk
        {
            public RpcCommandRequest<Assembly_CSharp_Generated_PlayerActionRPCSerializer, PlayerActionRPC>.SendRpcData data;
