...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_ChunkComponentSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_ChunkComponentGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
            ...
            IntPtr changeMaskData, int startOffset, ref Snapshot snapshot, ref Snapshot baseline)
        {
            ...
            if ((changeMask & (1 << 1)) != 0)
                ...
                snapshot.worldPos_x = baseline.worldPos_x;
            if ((changeMask & (1 << 1)) != 0)
        ...
        static void ReportPredictionErrorsGenerated(in ChunkComponent component, in ChunkComponent backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<ChunkComponent>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<ChunkComponent>(component),
                ref GhostComponentSerializer.TypeCast<ChunkComponent>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<ChunkComponent>(component),
                GhostComponentSerializer.TypeCast<ChunkComponent>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_ChunkComponentGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    VariantHash = 13647115872473700180,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("ChunkComponent"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("ChunkComponent")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_ChunkComponent");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_ChunkComponentGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    ChunkComponent,
                    Snapshot,
                    Assembly_CSharp_Generated_ChunkComponentGhostComponentSerializer
