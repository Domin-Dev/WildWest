...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_ChunkEventsSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_ChunkEventsGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        static void ReportPredictionErrorsGenerated(in ChunkEvents component, in ChunkEvents backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        static internal int GetPredictionErrorNamesGenerated(ref FixedString512Bytes names)
        {
            ...
            if (nameCount != 0)
                names.Append(new FixedString32Bytes(","));
            names.Append((FixedString512Bytes)".flags");
            ++nameCount;
            if (nameCount != 0)
                names.Append(new FixedString32Bytes(","));
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<ChunkEvents>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<ChunkEvents>(component),
                ref GhostComponentSerializer.TypeCast<ChunkEvents>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<ChunkEvents>(component),
                GhostComponentSerializer.TypeCast<ChunkEvents>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_ChunkEventsGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    VariantHash = 5138059294602664420,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("ChunkEvents"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("ChunkEvents")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_ChunkEvents");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_ChunkEventsGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    ChunkEvents,
                    Snapshot,
                    Assembly_CSharp_Generated_ChunkEventsGhostComponentSerializer
