...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_AimRotationSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_AimRotationGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref AimRotation component)
        {
                snapshot.angle = component.angle;
        }

        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.CopyFromSnapshotGenerated"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref AimRotation component,
        ...
        {
                component.angle = snapshotBefore.angle;
        }

        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.RestoreFromBackupGenerated"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref AimRotation component, ref AimRotation backup)
        {
        ...
        {
            uint changeMask = 0;
            changeMask = (snapshot.angle != baseline.angle) ? 1u : 0;
            ...
            ref DataStreamWriter writer, in StreamCompressionModel compressionModel)
        {
            ...
            if ((changeMask & (1 << 0)) != 0)
                writer.WritePackedFloatDelta(snapshot.angle, baseline.angle, compressionModel);
        }
            ...
            IntPtr changeMaskData, int startOffset, ref Snapshot snapshot, ref Snapshot baseline)
        {
            uint changeMask = GhostComponentSerializer.CopyFromChangeMask(changeMaskData, startOffset, ChangeMaskBits);
            if ((changeMask & (1 << 0)) != 0)
                snapshot.angle = reader.ReadPackedFloatDelta(baseline.angle, compressionModel);
            else
        ...
        static void ReportPredictionErrorsGenerated(in AimRotation component, in AimRotation backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        static internal int GetPredictionErrorNamesGenerated(ref FixedString512Bytes names)
        {
            ...
            names.Append((FixedString512Bytes)".angle");
            ++nameCount;
            return nameCount;
        }
#endif
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<AimRotation>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<AimRotation>(component),
                ref GhostComponentSerializer.TypeCast<AimRotation>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<AimRotation>(component),
                GhostComponentSerializer.TypeCast<AimRotation>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_AimRotationGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<AimRotation>(),
                    ComponentSize = UnsafeUtility.SizeOf<AimRotation>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 2564297717026188718,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("AimRotation"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("AimRotation")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_AimRotation");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_AimRotationGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    AimRotation,
                    Snapshot,
                    Assembly_CSharp_Generated_AimRotationGhostComponentSerializer
