...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_EmptyMagazineRPCCommandSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    [System.Runtime.CompilerServices.CompilerGenerated]
    [BurstCompile]
    internal struct Assembly_CSharp_Generated_EmptyMagazineRPCSerializer : IComponentData, IRpcCommandSerializer<EmptyMagazineRPC>
    {
        public void Serialize(ref DataStreamWriter writer, in RpcSerializerState state, in EmptyMagazineRPC data)
        {
        ...
        public void Deserialize(ref DataStreamReader reader, in RpcDeserializerState state, ref EmptyMagazineRPC data)
        {
        ...
        {
            RpcExecutor.ExecuteCreateRequestComponent<Assembly_CSharp_Generated_EmptyMagazineRPCSerializer, EmptyMagazineRPC>(ref parameters);
        }
    ...
    [BurstCompile]
    internal partial struct Assembly_CSharp_Generated_EmptyMagazineRPCRpcCommandRequestSystem : ISystem
    {
        RpcCommandRequest<Assembly_CSharp_Generated_EmptyMagazineRPCSerializer, EmptyMagazineRPC> m_Request;
        [BurstCompile]
        struct SendRpc : IJobChunk
        {
            public RpcCommandRequest<Assembly_CSharp_Generated_EmptyMagazineRPCSerializer, EmptyMagazineRPC>.SendRpcData data;
