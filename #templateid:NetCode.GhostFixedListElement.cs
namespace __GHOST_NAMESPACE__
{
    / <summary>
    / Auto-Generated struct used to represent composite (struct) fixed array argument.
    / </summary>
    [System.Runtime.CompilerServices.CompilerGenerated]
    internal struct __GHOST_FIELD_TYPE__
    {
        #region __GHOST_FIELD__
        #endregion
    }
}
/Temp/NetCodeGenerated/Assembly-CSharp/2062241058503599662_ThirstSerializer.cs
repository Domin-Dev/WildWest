...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_ThirstSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_ThirstGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref Thirst component)
        {
                snapshot.Value = (int) component.Value;
                snapshot.Max = (int) component.Max;
        }

        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.CopyFromSnapshotGenerated"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref Thirst component,
            float snapshotInterpolationFactor, float snapshotInterpolationFactorRaw, ref Snapshot snapshotBefore, ref Snapshot snapshotAfter)
        {
                ...
                component.Max = (int) snapshotBefore.Max;
        }

        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.RestoreFromBackupGenerated"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref Thirst component, ref Thirst backup)
        {
            ...
            [NoAlias]IntPtr changeMaskData, int startOffset)
        {
            ...
            changeMask |= (snapshot.Max != baseline.Max) ? (1u<<1) : 0;
        ...
        static void ReportPredictionErrorsGenerated(in Thirst component, in Thirst backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        static internal int GetPredictionErrorNamesGenerated(ref FixedString512Bytes names)
        {
            ...
            if (nameCount != 0)
                names.Append(new FixedString32Bytes(","));
            names.Append((FixedString512Bytes)".Max");
            ++nameCount;
            return nameCount;
        }
#endif
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<Thirst>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<Thirst>(component),
                ref GhostComponentSerializer.TypeCast<Thirst>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<Thirst>(component),
                GhostComponentSerializer.TypeCast<Thirst>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_ThirstGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<Thirst>(),
                    ComponentSize = UnsafeUtility.SizeOf<Thirst>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 16918806573181528252,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("Thirst"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("Thirst")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_Thirst");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_ThirstGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    Thirst,
                    Snapshot,
                    Assembly_CSharp_Generated_ThirstGhostComponentSerializer
