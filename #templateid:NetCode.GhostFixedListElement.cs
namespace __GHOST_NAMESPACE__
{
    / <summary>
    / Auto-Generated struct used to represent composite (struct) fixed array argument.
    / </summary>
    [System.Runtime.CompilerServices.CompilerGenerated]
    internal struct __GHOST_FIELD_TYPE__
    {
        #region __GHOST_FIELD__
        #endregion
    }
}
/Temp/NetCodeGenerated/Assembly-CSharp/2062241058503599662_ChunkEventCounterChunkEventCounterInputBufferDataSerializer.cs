...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_ChunkEventCounterChunkEventCounterInputBufferDataSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_ChunkEventCounterChunkEventCounterInputBufferDataGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref Unity.NetCode.InputBufferData<ChunkEventCounter> component)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref Unity.NetCode.InputBufferData<ChunkEventCounter> component,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref Unity.NetCode.InputBufferData<ChunkEventCounter> component, ref Unity.NetCode.InputBufferData<ChunkEventCounter> backup)
        {
        ...
        static void ReportPredictionErrorsGenerated(in Unity.NetCode.InputBufferData<ChunkEventCounter> component, in Unity.NetCode.InputBufferData<ChunkEventCounter> backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ChunkEventCounter>>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ChunkEventCounter>>(component),
                ref GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ChunkEventCounter>>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ChunkEventCounter>>(component),
                GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ChunkEventCounter>>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_ChunkEventCounterChunkEventCounterInputBufferDataGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<Unity.NetCode.InputBufferData<ChunkEventCounter>>(),
                    ComponentSize = UnsafeUtility.SizeOf<Unity.NetCode.InputBufferData<ChunkEventCounter>>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 8020427409600729298,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("Unity.NetCode.InputBufferData<ChunkEventCounter>"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("Unity.NetCode.InputBufferData`1[[ChunkEventCounter, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_ChunkEventCounterChunkEventCounterInputBufferData");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_ChunkEventCounterChunkEventCounterInputBufferDataGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    Unity.NetCode.InputBufferData<ChunkEventCounter>,
                    Snapshot,
                    Assembly_CSharp_Generated_ChunkEventCounterChunkEventCounterInputBufferDataGhostComponentSerializer
