...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_ItemInHandInputSyncSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_ItemInHandInputSyncGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        private const int ChangeMaskBits = 1;
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref ItemInHandInputSync component)
        {
                snapshot.itemInHand = (int) component.itemInHand;
        }

        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.CopyFromSnapshotGenerated"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref ItemInHandInputSync component,
        ...
        {
                component.itemInHand = (int) snapshotBefore.itemInHand;
        }

        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.RestoreFromBackupGenerated"/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref ItemInHandInputSync component, ref ItemInHandInputSync backup)
        {
            component.itemInHand = backup.itemInHand;
        }
        ...
        {
            snapshot.itemInHand = predictor.PredictInt(snapshot.itemInHand, baseline1.itemInHand, baseline2.itemInHand);
        }
        ...
        {
            uint changeMask = 0;
            changeMask = (snapshot.itemInHand != baseline.itemInHand) ? 1u : 0;
            GhostComponentSerializer.CopyToChangeMask(changeMaskData, changeMask, startOffset + 0, 1);
        }
            ...
            ref DataStreamWriter writer, in StreamCompressionModel compressionModel)
        {
            ...
            if ((changeMask & (1 << 0)) != 0)
                writer.WritePackedIntDelta(snapshot.itemInHand, baseline.itemInHand, compressionModel);
        }
            ...
            IntPtr changeMaskData, int startOffset, ref Snapshot snapshot, ref Snapshot baseline)
        {
            uint changeMask = GhostComponentSerializer.CopyFromChangeMask(changeMaskData, startOffset, ChangeMaskBits);
            if ((changeMask & (1 << 0)) != 0)
                snapshot.itemInHand = reader.ReadPackedIntDelta(baseline.itemInHand, compressionModel);
            else
                snapshot.itemInHand = baseline.itemInHand;
        }

#if UNITY_EDITOR || NETCODE_DEBUG
        /// <inheritdoc cref="IGhostSerializer{TComponent,TSnapshot}.ReportPredictionErrorsGenerated"/>
        static void ReportPredictionErrorsGenerated(in ItemInHandInputSync component, in ItemInHandInputSync backup, IntPtr errorsList,
            int errorsCount)
        {
            var errors = GhostComponentSerializer.ConvertToUnsafeList(errorsList, errorsCount);
            int errorIndex = 0;
            errors[errorIndex] = math.max(errors[errorIndex], math.abs(component.itemInHand - backup.itemInHand));
            ++errorIndex;
        }
        ...
        static internal int GetPredictionErrorNamesGenerated(ref FixedString512Bytes names)
        {
            ...
            names.Append((FixedString512Bytes)".itemInHand");
            ++nameCount;
            return nameCount;
        }
#endif
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<ItemInHandInputSync>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<ItemInHandInputSync>(component),
                ref GhostComponentSerializer.TypeCast<ItemInHandInputSync>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<ItemInHandInputSync>(component),
                GhostComponentSerializer.TypeCast<ItemInHandInputSync>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_ItemInHandInputSyncGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                ...
                {
                    GhostFieldsHash = 16573961985553786854,
                    ComponentType = ComponentType.ReadWrite<ItemInHandInputSync>(),
                    ComponentSize = UnsafeUtility.SizeOf<ItemInHandInputSync>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 4310138191122717212,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("ItemInHandInputSync"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("ItemInHandInputSync")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_ItemInHandInputSync");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_ItemInHandInputSyncGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    ItemInHandInputSync,
                    Snapshot,
                    Assembly_CSharp_Generated_ItemInHandInputSyncGhostComponentSerializer
