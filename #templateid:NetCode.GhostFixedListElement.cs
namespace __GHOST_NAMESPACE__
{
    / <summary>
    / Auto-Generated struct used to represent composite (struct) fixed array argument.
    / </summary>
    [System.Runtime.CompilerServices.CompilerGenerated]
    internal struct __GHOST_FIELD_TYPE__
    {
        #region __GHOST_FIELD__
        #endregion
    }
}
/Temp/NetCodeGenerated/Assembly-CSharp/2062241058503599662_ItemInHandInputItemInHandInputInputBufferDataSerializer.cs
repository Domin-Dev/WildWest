...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_ItemInHandInputItemInHandInputInputBufferDataSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_ItemInHandInputItemInHandInputInputBufferDataGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        {
            public int InternalInput_itemInHand;
            public uint Tick;
        }
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref Unity.NetCode.InputBufferData<ItemInHandInput> component)
        {
                snapshot.InternalInput_itemInHand = (int) component.InternalInput.itemInHand;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref Unity.NetCode.InputBufferData<ItemInHandInput> component,
        ...
        {
                component.InternalInput.itemInHand = (int) snapshotBefore.InternalInput_itemInHand;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref Unity.NetCode.InputBufferData<ItemInHandInput> component, ref Unity.NetCode.InputBufferData<ItemInHandInput> backup)
        {
            component.InternalInput.itemInHand = backup.InternalInput.itemInHand;
        ...
        {
            snapshot.InternalInput_itemInHand = predictor.PredictInt(snapshot.InternalInput_itemInHand, baseline1.InternalInput_itemInHand, baseline2.InternalInput_itemInHand);
        ...
        {
            uint changeMask = 0;
            changeMask = (snapshot.InternalInput_itemInHand != baseline.InternalInput_itemInHand) ? 1u : 0;
            ...
            ref DataStreamWriter writer, in StreamCompressionModel compressionModel)
        {
            ...
            if ((changeMask & (1 << 0)) != 0)
                writer.WritePackedIntDelta(snapshot.InternalInput_itemInHand, baseline.InternalInput_itemInHand, compressionModel);
            if ((changeMask & (1 << 1)) != 0)
            ...
            IntPtr changeMaskData, int startOffset, ref Snapshot snapshot, ref Snapshot baseline)
        {
            uint changeMask = GhostComponentSerializer.CopyFromChangeMask(changeMaskData, startOffset, ChangeMaskBits);
            if ((changeMask & (1 << 0)) != 0)
                snapshot.InternalInput_itemInHand = reader.ReadPackedIntDelta(baseline.InternalInput_itemInHand, compressionModel);
            else
                snapshot.InternalInput_itemInHand = baseline.InternalInput_itemInHand;
            if ((changeMask & (1 << 1)) != 0)
        ...
        static void ReportPredictionErrorsGenerated(in Unity.NetCode.InputBufferData<ItemInHandInput> component, in Unity.NetCode.InputBufferData<ItemInHandInput> backup, IntPtr errorsList,
            int errorsCount)
        {
            var errors = GhostComponentSerializer.ConvertToUnsafeList(errorsList, errorsCount);
            int errorIndex = 0;
            errors[errorIndex] = math.max(errors[errorIndex], math.abs(component.InternalInput.itemInHand - backup.InternalInput.itemInHand));
            ++errorIndex;
            {
            int tickErr = 0;
        ...
        static internal int GetPredictionErrorNamesGenerated(ref FixedString512Bytes names)
        {
            ...
            names.Append((FixedString512Bytes)".InternalInput.itemInHand");
            ++nameCount;
            if (nameCount != 0)
                names.Append(new FixedString32Bytes(","));
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ItemInHandInput>>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ItemInHandInput>>(component),
                ref GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ItemInHandInput>>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ItemInHandInput>>(component),
                GhostComponentSerializer.TypeCast<Unity.NetCode.InputBufferData<ItemInHandInput>>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_ItemInHandInputItemInHandInputInputBufferDataGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<Unity.NetCode.InputBufferData<ItemInHandInput>>(),
                    ComponentSize = UnsafeUtility.SizeOf<Unity.NetCode.InputBufferData<ItemInHandInput>>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 12969130615095415322,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("Unity.NetCode.InputBufferData<ItemInHandInput>"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("Unity.NetCode.InputBufferData`1[[ItemInHandInput, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_ItemInHandInputItemInHandInputInputBufferData");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_ItemInHandInputItemInHandInputInputBufferDataGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    Unity.NetCode.InputBufferData<ItemInHandInput>,
                    Snapshot,
                    Assembly_CSharp_Generated_ItemInHandInputItemInHandInputInputBufferDataGhostComponentSerializer
