...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_CurrentHitPointsSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_CurrentHitPointsGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref CurrentHitPoints component)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref CurrentHitPoints component,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref CurrentHitPoints component, ref CurrentHitPoints backup)
        {
        ...
        static void ReportPredictionErrorsGenerated(in CurrentHitPoints component, in CurrentHitPoints backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<CurrentHitPoints>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<CurrentHitPoints>(component),
                ref GhostComponentSerializer.TypeCast<CurrentHitPoints>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<CurrentHitPoints>(component),
                GhostComponentSerializer.TypeCast<CurrentHitPoints>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_CurrentHitPointsGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<CurrentHitPoints>(),
                    ComponentSize = UnsafeUtility.SizeOf<CurrentHitPoints>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 13772156756796214154,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("CurrentHitPoints"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("CurrentHitPoints")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_CurrentHitPoints");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_CurrentHitPointsGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    CurrentHitPoints,
                    Snapshot,
                    Assembly_CSharp_Generated_CurrentHitPointsGhostComponentSerializer
