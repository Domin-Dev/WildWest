...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_DestroyAtTickSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_DestroyAtTickGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        static void CopyToSnapshotGenerated(in GhostSerializerState serializerState, ref Snapshot snapshot, ref DestroyAtTick component)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref DestroyAtTick component,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void RestoreFromBackupGenerated(ref DestroyAtTick component, ref DestroyAtTick backup)
        {
        ...
        {
            uint changeMask = 0;
            changeMask = (snapshot.tick != baseline.tick) ? 1u : 0;
        ...
        static void ReportPredictionErrorsGenerated(in DestroyAtTick component, in DestroyAtTick backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<DestroyAtTick>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<DestroyAtTick>(component),
                ref GhostComponentSerializer.TypeCast<DestroyAtTick>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<DestroyAtTick>(component),
                GhostComponentSerializer.TypeCast<DestroyAtTick>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_DestroyAtTickGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<DestroyAtTick>(),
                    ComponentSize = UnsafeUtility.SizeOf<DestroyAtTick>(),
#if COMPONENT_HAS_GHOST_FIELDS
                    ...
                    VariantHash = 17468429233636012820,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("DestroyAtTick"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("DestroyAtTick")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_DestroyAtTick");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_DestroyAtTickGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    DestroyAtTick,
                    Snapshot,
                    Assembly_CSharp_Generated_DestroyAtTickGhostComponentSerializer
