...
/Temp/NetCodeGenerated/Assembly-CSharp/2062241058503599662_LinkedContainersSerializer.cs"
...
namespace Assembly_CSharp_Generated
{
    ...
    /// </summary>
    public partial struct Assembly_CSharp_Generated_LinkedContainersGhostComponentSerializer : IGhostSerializer
    {
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        static void CopyFromSnapshotGenerated(in GhostDeserializerState deserializerState, ref LinkedContainers component,
        ...
        static void ReportPredictionErrorsGenerated(in LinkedContainers component, in LinkedContainers backup, IntPtr errorsList,
            int errorsCount)
        {
        ...
        public void CopyToSnapshot(in GhostSerializerState serializerState, [NoAlias]IntPtr snapshot, [NoAlias][ReadOnly]IntPtr component)
        {
            CopyToSnapshotGenerated(serializerState, ref GhostComponentSerializer.TypeCast<Snapshot>(snapshot),
                ref GhostComponentSerializer.TypeCast<LinkedContainers>(component));
        }
        ...
        public void RestoreFromBackup([NoAlias] IntPtr component, [NoAlias] [ReadOnly] IntPtr backup)
        {
            RestoreFromBackupGenerated(
                ref GhostComponentSerializer.TypeCast<LinkedContainers>(component),
                ref GhostComponentSerializer.TypeCast<LinkedContainers>(backup));
        }
        ...
        public void ReportPredictionErrors([NoAlias][ReadOnly]IntPtr component, [NoAlias][ReadOnly]IntPtr backup, IntPtr errorsList,
            int errorsCount)
        {
            ReportPredictionErrorsGenerated(GhostComponentSerializer.TypeCast<LinkedContainers>(component),
                GhostComponentSerializer.TypeCast<LinkedContainers>(backup), errorsList, errorsCount);
        }
#endif
    }
    ...
    public partial struct Assembly_CSharp_Generated_LinkedContainersGhostComponentSerializer : IGhostSerializer
    {
        static internal GhostComponentSerializer.State GetState(ref SystemState state)
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    VariantHash = 18134272274485239454,
                    SerializationStrategyIndex = -1,
                    SerializesEnabledBit = 0,
#if UNITY_EDITOR || NETCODE_DEBUG
                    ProfilerMarker = new Unity.Profiling.ProfilerMarker("LinkedContainers"),
                    VariantTypeFullNameHash = TypeHash.FNV1A64("LinkedContainers")
#endif
                };
                ...
                var innerMarker = new Unity.Profiling.ProfilerMarker("Assembly_CSharp_Generated_LinkedContainers");
                innerMarker.Begin();
#endif
        ...
        {
#if COMPONENT_HAS_GHOST_FIELDS
            var serializer = default(Assembly_CSharp_Generated_LinkedContainersGhostComponentSerializer);
            Unity.NetCode.ComponentSerializationHelper<
                    LinkedContainers,
                    Snapshot,
                    Assembly_CSharp_Generated_LinkedContainersGhostComponentSerializer
