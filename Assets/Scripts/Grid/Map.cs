...
public class Map
{
    ...
    public int widthInChunks { private set; get; }// inChunks
...
public struct ServerMap
{
    ...
    public NativeHashMap<int,ServerChunk> chunks;
   
    public ServerMap(Vector2 offset, float cellSize, int chunkSize,int widthInChunks, int heightInChunks)
    {
        chunks = new NativeHashMap<int, ServerChunk>(128,Allocator.Persistent);
        this.offset = offset;
        this.cellSize = cellSize;  
        this.chunkSize = chunkSize;
        this.widthInChunks = widthInChunks;
